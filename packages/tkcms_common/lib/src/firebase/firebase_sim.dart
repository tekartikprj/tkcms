...
/// Bad name
@Deprecated('Use initFirebaseServicesMemory instead')
Future<FirebaseServicesContext> initFirebaseServicesSimMemory() async {
  return await initFirebaseServicesMemory();
}

/// Init memory services.
Future<FirebaseServicesContext> initFirebaseServicesMemory() async {
